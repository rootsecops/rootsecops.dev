        ...
        <div className="max-w-3xl mx-auto text-left">
          <motion.div variants={sectionVariants}>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} className="inline-block mt-2">
              <Link href="https://www.linkedin.com/in/rootsecops/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary hover:text-primary/80 font-medium transition-colors">
