...
// This avoids needing to make the homepage a dynamic route.
...
export default function BlogSection({ isHomePage = false }: { isHomePage?: boolean }) {
  ...
  useEffect(() => {
    getPosts().then(allPosts => {
        setPosts(isHomePage ? allPosts.slice(0, 2) : allPosts);
    });
  }, [isHomePage]);
    ...
    >
      <div className="container mx-auto px-4">
        <SectionTitle
          ...
          description="Insights, tutorials, and thoughts on cybersecurity and technology."
        />
