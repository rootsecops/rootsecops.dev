          ...
          <motion.div>
            ...
            <CardHeader>
              ...
              <CardContent className="space-y-4">
                  <div className="flex items-center group p-3 rounded-md">
                      <div className="flex-shrink-0 bg-primary/10 p-3 rounded-full mr-4">
                          <Mail className="h-6 w-6 text-primary" />
                      </div>
                      <div>
                          <p className="font-semibold text-foreground">Email</p>
                          <a href="mailto:contact@son4jit.qzz.io" className="text-sm text-muted-foreground hover:text-primary transition-colors">contact@son4jit.qzz.io</a>
                      </div>
                  </div>
                  <Link href="https://www.linkedin.com/in/sonajitrabha/" target="_blank" rel="noopener noreferrer" className="flex items-center group p-3 rounded-md hover:bg-muted transition-colors">
