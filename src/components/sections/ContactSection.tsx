                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormField control={form.control} name="email" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input type="email" placeholder="contact@rootsecops.dev" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )} />
          ...
          <motion.div>
            ...
            <CardHeader>
              ...
              <CardContent className="space-y-4">
                  <Link href="mailto:contact@rootsecops.dev" className="flex items-center group p-3 rounded-md hover:bg-muted transition-colors">
                      ...
                      <div>
                          ...
                          <p className="text-sm text-muted-foreground">contact@rootsecops.dev</p>
                      </div>
                  </Link>
                  <Link href="https://www.linkedin.com/in/rootsecops/" target="_blank" rel="noopener noreferrer" className="flex items-center group p-3 rounded-md hover:bg-muted transition-colors">
                      <div className="flex-shrink-0 bg-primary/10 p-3 rounded-full mr-4 group-hover:bg-primary/20 transition-colors">
