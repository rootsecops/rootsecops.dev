...
const experienceData = [
  {
    ...
    logoUrl: 'https://raw.githubusercontent.com/rootsecops/rootsecops/refs/heads/main/assets/img/academic-experience_img/en.png',
...
const educationAndCertsData = [
    {
      ...
      logoUrl: 'https://raw.githubusercontent.com/rootsecops/rootsecops/refs/heads/main/assets/img/academic-experience_img/PDUAM_logo.png',
    ...
    },
    {
      ...
      logoUrl: 'https://raw.githubusercontent.com/rootsecops/rootsecops/refs/heads/main/assets/img/academic-experience_img/dca.png',
...
export default function AcademicBackgroundSection() {
  ...
  return (
    <section id="experience" className="py-4 md:py-8">
