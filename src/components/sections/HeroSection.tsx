        ...
        <div className="retro-window-body flex flex-col md:flex-row items-center gap-6">
            <div className="flex-shrink-0">
                <div className="relative w-36 h-36 md:w-48 md:h-48 border-2 border-foreground bg-foreground p-1">
                    <Image
                        src="https://raw.githubusercontent.com/rootsecops/rootsecops/refs/heads/main/assets/img/heroimg/whoami.png"
            ...
            <div className="text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start space-x-5">
                    ...
                    <Link href="https://www.linkedin.com/in/rootsecops/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-foreground hover:text-primary transition-colors">
                        <Linkedin size={24} />
                    </Link>
                </div>
            </div>
