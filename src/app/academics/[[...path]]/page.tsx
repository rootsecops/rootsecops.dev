...
const academicLinks = [
    {
      icon: Book,
      title: "Class Notes",
      description: "A collection of my semester notes and study materials from my course",
      link: "/academics/classnotes",
    },
    {
      icon: Code,
      title: "Codes",
      description: "A collection of my programs & codes, DS and OOPs and more",
      link: "/academics/codes",
    },
];

export default function AcademicsLandingPage() {
    const pathname = usePathname();
    const isRootAcademics = pathname === '/academics';
